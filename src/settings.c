...
void Settings_draw(
    ...
    const Rect tile_size_rect = {
      WINDOW_WIDTH / 2 - BUTTON_WIDTH / 2,
      SETTINGS_TOP_PADDING + (BUTTON_HEIGHT + SETTINGS_BUTTON_PADDING) * 2,
      BUTTON_WIDTH,
      BUTTON_HEIGHT
    };
    ...
    const Rect tile_offset_rect = {
      WINDOW_WIDTH / 2 - BUTTON_WIDTH / 2,
      SETTINGS_TOP_PADDING + (BUTTON_HEIGHT + SETTINGS_BUTTON_PADDING) * 3,
      BUTTON_WIDTH,
      BUTTON_HEIGHT
    };
    ...
    const Rect speed_rect = {
      WINDOW_WIDTH / 2 - BUTTON_WIDTH / 2,
      SETTINGS_TOP_PADDING + (BUTTON_HEIGHT + SETTINGS_BUTTON_PADDING) * 4,
      BUTTON_WIDTH,
      BUTTON_HEIGHT
    };
    ...
    const Rect back_rect = {
      WINDOW_WIDTH / 2 - BUTTON_WIDTH / 2,
      SETTINGS_TOP_PADDING + (BUTTON_HEIGHT + SETTINGS_BUTTON_PADDING) * 6,
      BUTTON_WIDTH,
      BUTTON_HEIGHT
    };
